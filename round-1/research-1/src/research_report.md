...
**Block 1: Z3 Python API for FOL Entailment**
...
[1] [LINC: A Neurosymbolic Approach for Logical Reasoning by Combining Language Models with First-Order Logic Provers (EMNLP 2023)](https://aclanthology.org/2023.emnlp-main.313.pdf) — Primary source for few-shot prompt format (Appendix D.4), FOL syntax (NLTK logic module), Prover9 as backend, error analysis (arity mismatch rates), and 8 FOLIO ICL examples. Key finding: LINC uses Prover9 not Z3.

[2] [Z3Py Advanced Examples](https://ericpony.github.io/z3py-tutorial/advanced-examples.htm) — Confirmed Z3 Python API patterns: DeclareSort, ForAll with multiple variables, push/pop scope management, and entailment via unsat checking.

[3] [Programming Z3 (Stanford)](https://theory.stanford.edu/~nikolaj/programmingz3.html) — Reference for Z3 solver incremental API, quantifier binding, and the prove-by-negation pattern.

[4] [Llama 3.1 8B Instruct - OpenRouter](https://openrouter.ai/meta-llama/llama-3.1-8b-instruct) — Confirmed model ID, pricing ($0.02/$0.03 per 1M tokens), 131K context window, available status.

[5] [Qwen2.5 7B Instruct - OpenRouter](https://openrouter.ai/qwen/qwen-2.5-7b-instruct) — Confirmed model ID, pricing ($0.04/$0.10 per 1M tokens), 131K context window, available status.

[6] [Qwen2.5 7B Instruct (Free) - OpenRouter](https://openrouter.ai/qwen/qwen-2.5-7b-instruct:free) — Confirmed free tier exists with 2 providers, 131K context. Major cost saving: oracle calls could be free.

[7] [FOLIO Validation Dataset (Yale-LILY)](https://raw.githubusercontent.com/Yale-LILY/FOLIO/main/data/v0.0/folio-validation.jsonl) — Provided 5 concrete NL→FOL example pairs from the actual FOLIO dataset, confirming predicate naming conventions and quantifier patterns.

[8] [LINC GitHub Repository (benlipkin)](https://github.com/benlipkin/linc) — Confirmed repository structure; uses Prover9 (not Z3) as theorem prover backend; primarily Jupyter notebooks.

[9] [Getting Started with Z3 Guide](https://www.philipzucker.com/z3-rise4fun/guide.html) — Additional Z3 patterns including push/pop scope management for entailment checking.

[10] [LOGICPO: Efficient Translation of NL-based Logical Problems to FOL using LLMs](https://arxiv.org/pdf/2506.18383) — Recent (2025) work on NL-to-FOL translation confirming the continued use of similar few-shot prompting patterns.
