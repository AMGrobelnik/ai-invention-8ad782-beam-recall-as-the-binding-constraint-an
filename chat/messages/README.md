...
- **1. create_idea** — `hypo_loop`
  - round_1
    - `chat/messages/1_create_idea/round_1/1_gen_hypo.md` — 34 messages
  ...
  - round_2
    ...
    - `chat/messages/1_create_idea/round_2/2_review_hypo.md` — 21 messages
- **2. test_idea** — `invention_loop`
  - round_1
    ...
    - `2_gen_plan/` — 4 task(s)
      ...
      - `chat/messages/2_test_idea/round_1/2_gen_plan/gen_plan_experiment_1.md` — 4 messages
      - `chat/messages/2_test_idea/round_1/2_gen_plan/gen_plan_research_1.md` — 44 messages
    - `3_gen_art/` — 4 task(s)
      - `chat/messages/2_test_idea/round_1/3_gen_art/gen_art_dataset_1.md` — 155 messages
      - `chat/messages/2_test_idea/round_1/3_gen_art/gen_art_evaluation_1.md` — 957 messages
    ...
    - `chat/messages/2_test_idea/round_1/4_gen_paper_text.md` — 52 messages
  ...
  - round_2
    ...
    - `3_gen_art/` — 2 task(s)
      - `chat/messages/2_test_idea/round_2/3_gen_art/gen_art_evaluation_1.md` — 113 messages
      - `chat/messages/2_test_idea/round_2/3_gen_art/gen_art_experiment_1.md` — 258 messages
    - `chat/messages/2_test_idea/round_2/4_gen_paper_text.md` — 43 messages
...
- **3. report_results** — `gen_paper_repo`
  - `1_gen_viz/` — 3 task(s)
    - `chat/messages/3_report_results/1_gen_viz/gen_viz_1.md` — 22 messages
    - `chat/messages/3_report_results/1_gen_viz/gen_viz_2.md` — 30 messages
    - `chat/messages/3_report_results/1_gen_viz/gen_viz_3.md` — 22 messages
  - `2_gen_art_demo/` — 4 task(s)
    - `chat/messages/3_report_results/2_gen_art_demo/gen_art_demo_dataset_1.md` — 86 messages
    - `chat/messages/3_report_results/2_gen_art_demo/gen_art_demo_evaluation_1.md` — 56 messages
    - `chat/messages/3_report_results/2_gen_art_demo/gen_art_demo_experiment_1.md` — 127 messages
    - `chat/messages/3_report_results/2_gen_art_demo/gen_art_demo_experiment_2.md` — 233 messages
