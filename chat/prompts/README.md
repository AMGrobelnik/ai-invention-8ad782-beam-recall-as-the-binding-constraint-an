...
- **2. test_idea** — `invention_loop`
  - round_1
    ...
    - `2_gen_art/` — 4 task(s)
      - `chat/prompts/2_test_idea/round_1/2_gen_art/gen_art_dataset_1.md` — 3 prompts
      - `chat/prompts/2_test_idea/round_1/2_gen_art/gen_art_evaluation_1.md` — 6 prompts
  ...
  - round_2
    - `1_gen_art/` — 2 task(s)
      ...
      - `chat/prompts/2_test_idea/round_2/1_gen_art/gen_art_experiment_1.md` — 6 prompts
    - `chat/prompts/2_test_idea/round_2/2_gen_paper_text.md` — 2 prompts
- **3. report_results** — `gen_paper_repo`
  ...
  - `2_gen_art_demo/` — 4 task(s)
    ...
    - `chat/prompts/3_report_results/2_gen_art_demo/gen_art_demo_experiment_2.md` — 4 prompts
